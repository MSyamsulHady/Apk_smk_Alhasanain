                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    <form action="{{ route('deleteMapel', $pel->id_mapel) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="button" data-toggle="" title="" data-id=""
                                                            data-nama="{{$pel->nama_mapel}}" class="btn btn-link btn-danger deletealertsiswa"
                            ...
                            @foreach ($pelajaran as $pl)
                                <div class="modal fade bd-example-modal-lg" id="ModalEdit{{ $pl->id_mapel }}" tabindex="-1"
