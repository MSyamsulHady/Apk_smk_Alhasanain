            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            ...
                                            <form action="" method="POST">
                                                @csrf
                                                @method('okus')
                                                <button type="button" data-toggle="" title="" data-id="" data-nama="" class="btn btn-link btn-danger deletealertsiswa" data-original-title="Hapus">
                                            ...
                                            <div class="row">
                                                <div class="col-lg">
                                                    ...
                                                    <input type="text" class="form-control @error('nama_mapel')
                                                        is-invalid
                                                        @enderror" placeholder="Mata Pelajaran" name="nama_mapel"><br>
                                                    @error('nama_mapel')
                        ...
                        <div class="modal fade bd-example-modal-lg" id="ModalEdit{{ $pl->id_mapel }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <form action="{{ route('updatemapel', $pl->id_mapel) }}" method="POST">
                                            ...
                                            <div class="row">
                                                <div class="col-lg">
                                                    ...
                                                    <input type="text" class="form-control @error('nama_mapel')
                                                        is-invalid
                                                        @enderror" placeholder="Mata Pelajaran" name="nama_mapel" value="{{ $pl->nama_mapel }}"><br>
                                                    @error('nama_mapel')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                    <label for="nama_mapel">
