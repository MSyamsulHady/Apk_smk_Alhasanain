        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <button type="button" data-toggle="modal" data-target="#ModalEdit{{ $kls->id_kelas }}" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit ">
                                                <i class="fa fa-edit"></i>
                                            </button>
                                            <a href="{{ route('detailkelas', $kls->id_kelas) }}" class="btn btn-link btn-danger btn-lg" data-original-title="Hapus ">
                                            ...
                                            <div class="col-lg">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error('nama_kelas')  is-invalid
                                                            @enderror" id="nama_kelas" name="nama_kelas" placeholder="nama_kelas">
                                                    @error('nama_kelas')
                    ...
                    @foreach ($kelas as $kl)
                    {{-- modal update --}}
                    <div class="modal fade " id="ModalEdit{{ $kl->id_kelas }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Input Semester</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-lg">
                                                ...
                                                <div class="form-group">
                                                    <label for="nama_kelas">Nama Kelas</label>
                                                    <input type="text" class="form-control @error('nama_kelas')  is-invalid
                                                           @enderror" id="nama_kelas" name="nama_kelas" placeholder="nama_kelas" value="{{ $kl->nama_kelas }}">
                                                    @error('nama_kelas')
                                                    <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
